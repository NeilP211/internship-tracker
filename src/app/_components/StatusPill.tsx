    ...
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div
          ...
          className="absolute left-0 top-full mt-2 w-[calc(100vw-1rem)] max-w-[420px] z-50 rounded-lg border border-white/15 bg-[oklch(0.18_0.005_260)] shadow-[0_8px_24px_oklch(0_0_0_/_50%)] p-3 space-y-3"
        >
